...
stage('Provision and Deploy') {
    steps {
        withCredentials([
            ...
            cd ansible_files
            ansible-playbook provision_prod.yml --extra-vars "app_tag=${params.APP_TAG}" --private-key ~/devops-lab-project/ansible_files/flask_running_app_staging_key.pem -u ubuntu
            """
        }
    }
}
